...
public class WithTest {
	...
	private static void withTest(AbstractOberon oberon0, int runs, int inputLength) {
		WithTest qs = new WithTest(new Oberon(), runs, inputLength);
		long duration = timedRun(qs);
		double seconds = duration / 1000.0;
		System.out.println(" :" + runs + " of testing WithStatement with " + inputLength + " elements (" 
				+ oberon0.getName() + "): " 
