...
public class TestArrayScript {
	public static void main(String[] args) throws IOException {
		...
		int size = ((IntegerValue) context.getReference("INPUTLENGTH")
				.getValue()).getValue();
		...
		for (int i = 0; i < size; i++) {
			...
			assert (value == currentExpected) : "Array testscript failed, at position "
					+ i + ", expected " + expected[i] + " , but got: " + value;
		}
		// test passed
