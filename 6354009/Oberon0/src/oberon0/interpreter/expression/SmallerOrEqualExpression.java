...
public class SmallerOrEqualExpression extends LeftRightExpression implements Expression {

	public static String TYPE = "SMALLER_OR_EQUAL_EXPRESSION";
	
	public SmallerOrEqualExpression(Expression operatorLeft, Expression operatorRight) {
