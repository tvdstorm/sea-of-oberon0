...
public class InfixGreaterEqualsExpression extends InfixExpression
{
	public InfixGreaterEqualsExpression(Expression _leftHandExpression, Expression _rightHandExpression)
	{
