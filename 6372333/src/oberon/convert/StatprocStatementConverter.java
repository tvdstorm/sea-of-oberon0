...
/**
 * The Class StatprocStatementConverter.
 */
public class StatprocStatementConverter extends AbstractConverter<IStatement> {
	...
	public void caseAProcedurecall(final AProcedurecall node)
	{
		...
		{
			expressions.add(ExpConverterFactory.getExpression(exp));
		}
	}
