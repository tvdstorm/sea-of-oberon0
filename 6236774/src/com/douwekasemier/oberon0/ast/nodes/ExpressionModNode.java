...
public class ExpressionModNode extends BinaryExpressionNode implements Node {

    public ExpressionModNode(Tree node, Node parent) throws ASTGenerationException {
        super(node, parent);
