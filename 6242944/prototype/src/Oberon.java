...
// on Monday, January 10, 2011 at 7:58:24 PM.
...
public final class Oberon extends ParserBase {
  ...
  private Result pTerm$$Star1$1(final int yyStart) throws IOException {
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Action<ast.Expression> v$el$1 = yyResult.semanticValue();

      yyResult = pTerm$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Action<ast.Expression>> v$2 = yyResult.semanticValue();

        yyValue = new Pair<Action<ast.Expression>>(v$el$1, v$2);
  ...
  private Result pFormalParameters(final int yyStart) throws IOException {
    ...
    if ('(' == yyC) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        List<ast.Parameter> args1 = yyResult.semanticValue();
        ...
        while (true) {
          ...
          if (';' == yyC) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyRepetition1 = yyResult.index;
              yyRepValue1   = 
                new Pair<List<ast.Parameter>>(v$el$1, yyRepValue1);
              continue;
            }
          } else {
            yyError = yyError.select("';' expected", yyBase);
            ...
            if (',' == yyC) {
              ...
              if (yyResult.hasValue()) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  yyRepetition1 = yyResult.index;
                  yyRepValue1   = 
                    new Pair<ast.Expression>(v$el$1, yyRepValue1);
                  continue;
                }
              }
            } else {
  ...
  public Result pProcedureCall(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyError  = yyResult.select(yyError, yyOption1);
      if (yyResult.hasValue()) {
        Pair<ast.Expression> v$el$1 = yyResult.semanticValue();

        yyOption1  = yyResult.index;
        yyOpValue1 = v$el$1;
      }
      { // Start scope for params.
        Pair<ast.Expression> params = yyOpValue1;
