...
// on Thursday, January 6, 2011 at 9:52:10 PM.
...
public final class Oberon extends ParserBase {
  ...
  /**
   * Parse nonterminal Oberon.BinaryExpression.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBinaryExpression(final int yyStart) throws IOException {
    Result         yyResult;
    ast.Expression yyValue;
    ParseError     yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pBinaryExpression$$Choice1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal Oberon.BinaryExpression$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBinaryExpression$$Choice1(final int yyStart) 
    throws IOException {
    ...
    // Done.
    yyError = yyError.select("binary expression expected", yyStart);
    return yyError;
  }
  ...
  private Result pExpression$1(final int yyStart) throws IOException {
    ...
    yyResult = pBinaryExpression(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  private Result pStatementSequence(final int yyStart) throws IOException {
    ...
    int                 yyBase;
    int                 yyRepetition1;
    Pair<ast.Statement> yyRepValue1;
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        if (';' == yyC) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyRepetition1 = yyResult.index;
            yyRepValue1   = new Pair<ast.Statement>(v$el$1, yyRepValue1);
            continue;
          }
        } else {
          yyError = yyError.select("';' expected", yyBase);
      ...
      { // Start scope for s2.
        Pair<ast.Statement> s2 = yyRepValue1.reverse();
  ...
  public Result pModule(final int yyStart) throws IOException {
    ...
    int                  yyOption1;
    Pair<ast.Expression> yyOpValue1;
    ast.Node             yyValue;
    ParseError           yyError = ParseError.DUMMY;
                        ...
                        if (';' == yyC) {
                          ...
                          if (yyResult.hasValue()) {
                            ...
                            if (yyResult.hasValue()) {
                                      ...
                                      if ('N' == yyC) {
                                        ...
                                        if (yyResult.hasValue()) {
                                          ...
                                          while (true) {
                                            ...
                                            yyResult = 
                                              pExpression(yyRepetition1);
                                            yyError  = 
                                              yyResult.select(yyError, yyRepetition1);
                                            if (yyResult.hasValue()) {
                                              ast.Expression v$el$2 = yyResult.semanticValue();

                                              yyRepetition1 = yyResult.index;
                                              yyRepValue1   = 
                                                new Pair<ast.Expression>(v$el$2, yyRepValue1);
                                              continue;
                                            }
                                            break;
                                          }
                                          { // Start scope for v$el$1.
                                            Pair<ast.Expression> v$el$1 = yyRepValue1.reverse();
                              ...
                              { // Start scope for expr.
                                Pair<ast.Expression> expr = yyOpValue1;
