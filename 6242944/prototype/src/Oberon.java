...
// on Friday, January 7, 2011 at 1:58:20 PM.
...
public final class Oberon extends ParserBase {
  ...
  private Result pDeclarations$1(final int yyStart) throws IOException {
    ...
    int                        yyBase;
    int                        yyOption1;
    Pair<ast.ConstDeclaration> yyOpValue1;
    List<ast.Declaration>      yyValue;
    ParseError                 yyError = ParseError.DUMMY;
    ...
    { // Start scope for consts.
      Pair<ast.ConstDeclaration> consts = yyOpValue1;

      yyResult = pDeclarations$$Star2(yyOption1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  private Result pDeclarations$$Star1(final int yyStart) throws IOException {
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fDeclarations$$Star1) 
      yyColumn.chunk1.fDeclarations$$Star1 = pDeclarations$$Star1$1(yyStart);
    return yyColumn.chunk1.fDeclarations$$Star1;
  }
  ...
  private Result pDeclarations$$Star2(final int yyStart) throws IOException {
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fDeclarations$$Star2) 
      yyColumn.chunk1.fDeclarations$$Star2 = pDeclarations$$Star2$1(yyStart);
    return yyColumn.chunk1.fDeclarations$$Star2;
  }
  ...
  private Result pDeclarations$$Star2$1(final int yyStart) 
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      ast.Procedure v$el$4 = yyResult.semanticValue();
      ...
      if (';' == yyC) {
        ...
        yyResult = pDeclarations$$Star2(yyIndex);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Pair<ast.Procedure> v$5 = yyResult.semanticValue();

          yyValue = new Pair<ast.Procedure>(v$el$4, v$5);
                        ...
                        if (yyResult.hasValue()) {
                          ...
                          if (';' == yyC) {
                            ...
                            if (yyResult.hasValue()) {
                              ...
                              yyError  = yyResult.select(yyError);
                              if (yyResult.hasValue()) {
                                List<ast.Declaration> decl = yyResult.semanticValue();
  ...
  public Result pElseTail(final int yyStart) throws IOException {
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fElseTail) 
      yyColumn.chunk1.fElseTail = pElseTail$1(yyStart);
    return yyColumn.chunk1.fElseTail;
  }
