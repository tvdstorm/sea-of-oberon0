...
// on Monday, January 10, 2011 at 3:39:55 PM.
                      ...
                      if (yyResult.hasValue()) {
                        ...
                        if (yyResult.hasValue()) {
                          ...
                          { // Start scope for params.
                            List<ast.Parameter> params = cast(yyOpValue1);
                                ...
                                if (yyResult.hasValue()) {
                                  ...
                                  if (yyResult.hasValue()) {
                                            ...
                                            if ('N' == yyC) {
                                              ...
                                              if (yyResult.hasValue()) {
                                                ...
                                                yyError  = 
                                                  yyResult.select(yyError, yyOption1);
                                                if (yyResult.hasValue()) {
                                                  ast.StatementSequence v$el$2 = yyResult.semanticValue();
                                    ...
                                    { // Start scope for stat.
                                      ast.StatementSequence stat = cast(yyOpValue1);
