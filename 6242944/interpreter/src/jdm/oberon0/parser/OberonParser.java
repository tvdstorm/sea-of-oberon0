...
// on Saturday, February 5, 2011 at 2:44:25 PM.
...
import jdm.oberon0.ast.expressions.AddExpression;
import jdm.oberon0.ast.expressions.AndExpression;
import jdm.oberon0.ast.expressions.ArraySelector;
import jdm.oberon0.ast.expressions.DivExpression;
import jdm.oberon0.ast.expressions.EqExpression;
import jdm.oberon0.ast.expressions.Expression;
import jdm.oberon0.ast.expressions.GeExpression;
import jdm.oberon0.ast.expressions.GtExpression;
import jdm.oberon0.ast.expressions.Identifier;
import jdm.oberon0.ast.expressions.IntegerLiteral;
import jdm.oberon0.ast.expressions.LeExpression;
import jdm.oberon0.ast.expressions.LtExpression;
import jdm.oberon0.ast.expressions.ModExpression;
import jdm.oberon0.ast.expressions.MulExpression;
import jdm.oberon0.ast.expressions.NeExpression;
import jdm.oberon0.ast.expressions.NegExpression;
import jdm.oberon0.ast.expressions.NotExpression;
import jdm.oberon0.ast.expressions.OrExpression;
import jdm.oberon0.ast.expressions.PosExpression;
import jdm.oberon0.ast.expressions.RecordSelector;
import jdm.oberon0.ast.expressions.SubExpression;
import jdm.oberon0.ast.statements.Assignment;
import jdm.oberon0.ast.statements.IfStatement;
import jdm.oberon0.ast.statements.ProcedureCall;
import jdm.oberon0.ast.statements.Statement;
import jdm.oberon0.ast.statements.StatementSequence;
import jdm.oberon0.ast.statements.WhileStatement;
import jdm.oberon0.ast.types.Type;
import jdm.oberon0.ast.types.ArrayType;
import jdm.oberon0.ast.types.IdentifierType;
import jdm.oberon0.ast.types.RecordType;
...
public final class OberonParser extends ParserBase {
    ...
    { // Start scope for consts.
      ...
      { // Start scope for types.
        ...
        { // Start scope for vars.
          ...
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            Pair<Procedure> procs = yyResult.semanticValue();
  ...
  private Result pDeclarations$$Star4$1(final int yyStart) 
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Procedure v$el$10 = yyResult.semanticValue();

      yyResult = pDeclarations$$Star4(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        Pair<Procedure> v$11 = yyResult.semanticValue();

        yyValue = new Pair<Procedure>(v$el$10, v$11);
