...
public class ExpressionEqualsNode extends BinaryExpressionNode implements Node {

    public ExpressionEqualsNode(Tree node, Node parent) throws ASTGenerationException {
        super(node, parent);
