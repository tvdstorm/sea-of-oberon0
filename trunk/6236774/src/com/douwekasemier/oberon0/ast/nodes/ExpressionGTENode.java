...
public class ExpressionGTENode extends BinaryExpressionNode implements Node {

    public ExpressionGTENode(Tree node, Node parent) throws ASTGenerationException {
        super(node, parent);
