...
public class QuicksortQuickcheck {
	...
	/*
	 * Test the quicksort for a given number of times
	 * Tip: use ReadRandom instead of Read in the oberon script to generate numbers
	 */
	public static void quickcheckQuicksort(int repeats, String filename) throws IOException{
		for(int repeated=1; repeated <= repeats; repeated++)
		{
		    ...
		    for(int i = 0; i < size; i++){
		    	...
		    	assert(val>=previousVal) :"Test #"+ repeated +
		    				" failed: Quicksort is not working, output was: " + array.toString();
