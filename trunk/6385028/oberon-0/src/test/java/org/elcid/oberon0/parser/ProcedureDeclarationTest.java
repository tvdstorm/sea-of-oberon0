...
public class ProcedureDeclarationTest {
	...
	public ProcedureDeclarationTest() { }

	@Test
	public void testProcedure() throws Exception {
		// Create an input character stream from smoke test file
		ANTLRInputStream input = new ANTLRInputStream(ClassLoader.getSystemResourceAsStream("org/elcid/oberon0/parser/procedure.oberon0"));
