...
public final class AExsmeExpressionoperator extends PExpressionoperator
{
    private TExse _exse_;

    public AExsmeExpressionoperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExsmeExpressionoperator(
            cloneNode(this._exse_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAExsmeExpressionoperator(this);
    }
