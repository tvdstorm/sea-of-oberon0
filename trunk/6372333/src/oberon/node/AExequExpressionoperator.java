...
public final class AExequExpressionoperator extends PExpressionoperator
{
    private TExeq _exeq_;

    public AExequExpressionoperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExequExpressionoperator(
            cloneNode(this._exeq_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAExequExpressionoperator(this);
    }
