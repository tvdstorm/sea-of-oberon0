...
public final class AExsmtExpressionoperator extends PExpressionoperator
{
    private TExst _exst_;

    public AExsmtExpressionoperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExsmtExpressionoperator(
            cloneNode(this._exst_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAExsmtExpressionoperator(this);
    }
