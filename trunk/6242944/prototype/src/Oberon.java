...
// on Thursday, January 6, 2011 at 10:40:03 PM.
                                      ...
                                      if ('N' == yyC) {
                                        ...
                                        if (yyResult.hasValue()) {
                                          ...
                                          while (true) {
                                            ...
                                            yyResult = 
                                              pStatement(yyRepetition1);
                                            yyError  = 
                                              yyResult.select(yyError, yyRepetition1);
                                            if (yyResult.hasValue()) {
                                              ast.Statement v$el$2 = yyResult.semanticValue();

                                              yyRepetition1 = yyResult.index;
                                              yyRepValue1   = 
                                                new Pair<ast.Statement>(v$el$2, yyRepValue1);
                                              continue;
                                            }
                                            break;
                                          }
                                          { // Start scope for v$el$1.
                                            Pair<ast.Statement> v$el$1 = yyRepValue1.reverse();
