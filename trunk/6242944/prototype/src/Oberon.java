...
// on Friday, January 7, 2011 at 3:11:20 PM.
...
public final class Oberon extends ParserBase {
  ...
  private Result pIdentList(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        { // Start scope for ident2.
          Pair<String> ident2 = yyRepValue1.reverse();

          yyValue = new Pair<String>(ident1, ident2);

          return new SemanticValue(yyValue, yyRepetition1, yyError);
        } // End scope for ident2.
      }
    }
  ...
  private Result pDeclarations$$Star3(final int yyStart) throws IOException {
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fDeclarations$$Star3) 
      yyColumn.chunk1.fDeclarations$$Star3 = pDeclarations$$Star3$1(yyStart);
    return yyColumn.chunk1.fDeclarations$$Star3;
  }
