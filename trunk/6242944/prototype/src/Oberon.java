...
// on Friday, January 7, 2011 at 10:43:55 AM.
...
public final class Oberon extends ParserBase {
  ...
  private Result pStatementSequence(final int yyStart) throws IOException {
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fStatementSequence) 
      yyColumn.chunk1.fStatementSequence = pStatementSequence$1(yyStart);
    return yyColumn.chunk1.fStatementSequence;
  }
  ...
  private Result pStatementSequence$$Star1(final int yyStart) 
    ...
    OberonColumn yyColumn = (OberonColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fStatementSequence$$Star1) 
      yyColumn.chunk1.fStatementSequence$$Star1 = pStatementSequence$$Star1$1(yyStart);
    return yyColumn.chunk1.fStatementSequence$$Star1;
  }
                                        ...
                                        if (yyResult.hasValue()) {
                                          ...
                                          if ('.' == yyC) {
                                            ...
                                            if (yyResult.hasValue()) {
                                              ...
                                              yyValue = new ast.Module(ident, decl.list(), stat);
