...
// on Saturday, January 29, 2011 at 11:01:32 PM.
...
public final class OberonParser extends ParserBase {
                    ...
                    if ('O' == yyC) {
                      ...
                      if ('F' == yyC) {
                        ...
                        if (yyResult.hasValue()) {
                          ...
                          yyError  = yyResult.select(yyError);
                          if (yyResult.hasValue()) {
                            AbstractType type = yyResult.semanticValue();
  ...
  private Result pFieldList$1(final int yyStart) throws IOException {
    ...
    Result               yyResult;
    int                  yyBase;
    HashMap<String,AbstractType> yyValue;
    ParseError           yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (':' == yyC) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            AbstractType t = yyResult.semanticValue();
  ...
  private Result pRecordType(final int yyStart) throws IOException {
    ...
    int                        yyBase;
    int                        yyRepetition1;
    Pair<HashMap<String,AbstractType>> yyRepValue1;
    Record                 yyValue;
    ParseError                 yyError = ParseError.DUMMY;
            ...
            if ('R' == yyC) {
              ...
              if ('D' == yyC) {
                ...
                if (yyResult.hasValue()) {
                  ...
                  yyError  = yyResult.select(yyError);
                  if (yyResult.hasValue()) {
                    HashMap<String,AbstractType> l1 = yyResult.semanticValue();
                    ...
                    while (true) {
                      ...
                      if (';' == yyC) {
                        ...
                        if (yyResult.hasValue()) {
                          ...
                          yyError  = yyResult.select(yyError, yyRepetition1);
                          if (yyResult.hasValue()) {
                            HashMap<String,AbstractType> v$el$1 = yyResult.semanticValue();

                            yyRepetition1 = yyResult.index;
                            yyRepValue1   = 
                              new Pair<HashMap<String,AbstractType>>(v$el$1, yyRepValue1);
                            continue;
                          }
                        }
                      } else {
                    ...
                    { // Start scope for l2.
                      Pair<HashMap<String,AbstractType>> l2 = yyRepValue1.reverse();
