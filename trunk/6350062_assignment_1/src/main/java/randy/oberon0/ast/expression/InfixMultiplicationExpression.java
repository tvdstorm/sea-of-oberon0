...
public class InfixMultiplicationExpression extends InfixExpression
{
	public InfixMultiplicationExpression(Expression _leftHandExpression, Expression _rightHandExpression)
	{
