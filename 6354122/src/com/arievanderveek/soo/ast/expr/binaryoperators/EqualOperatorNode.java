...
public class EqualOperatorNode extends AbstractBinaryOperatorNode {

	public EqualOperatorNode(ExpressionNode leftHandNode, ExpressionNode rightHandNode) {
